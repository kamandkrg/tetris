...
colors = [(255, 0, 0), (0, 255, 0), (255, 255, 0), (255, 0, 255), (0, 255, 255), (150, 0, 0), (0, 0, 255),
          (193, 195, 194), (255, 255, 255)]
    ...
    for i in range(len(all_locations)):
        ...
        if i == c - 1:
            ...
            for i in range(k + 1):
                c += random_colors[i][1]
    for i in shape:
        pygame.draw.rect(win, random_color,
                         (i[0] * 20 + 240 + x_location_adding, i[1] * 20 + 20 + y_location_adding, 20, 20))
